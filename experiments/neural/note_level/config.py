...
hidden_dimensions=(200, 200) # pop, chorales, fugues
merge_layers=(False, False)
...
write_mode='a'
header = (
  "Conv=%d, Div=%d, Assignment Threshold=%f,"
  " Allow Overlap=%d, Epochs=%d, Batch Size=%d,"
  " Hidden Dimensions=%s, l2 reg=%f" % (
    conv_limit, div_limit, assignment_threshold, 
    allow_overlap, epochs, batch_size,
    str(hidden_dimensions), l2_reg
  )
)
